...
namespace DotDumperGUI.Models
{
    ...
    public class LogEntry
    {
        ...
        {
            int lastIndex = FunctionName.IndexOf(' ');
            string localFunctionName = FunctionName.Substring(lastIndex, FunctionName.Length - lastIndex);
            return "[" + DateTimeStamp + "] " + localFunctionName;
        }
    }
}
